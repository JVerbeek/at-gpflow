...
class K_full_model_sqexp(gpflow.kernels.Kernel):
    ...
    def __init__(self):
        ...
        self.lengthscale_11 = gpflow.Parameter(0.2, transform=tfp.bijectors.SoftClip(
            gpflow.utilities.to_default_float(0.00001),
            gpflow.utilities.to_default_float(1000.0)))
...
class K_full_model_1(gpflow.kernels.Kernel):
    ...
    def K(self, X, X2=None):
        ...
        diff_X_da_exp1 = tf.math.abs(X_matrix_da_exp1 - X_matrix_tr_da_exp1)/self.lengthscale_11
        ...
        diff_X_da_exp2 = tf.math.abs(X_matrix_da_exp2 - X_matrix_tr_da_exp2)/self.lengthscale_11
...
class K_full_model_2(gpflow.kernels.Kernel):
    ...
    def __init__(self):
        ...
        self.variance_22 = gpflow.Parameter(1.0, transform=tfp.bijectors.SoftClip(
            gpflow.utilities.to_default_float(0.00001),
            gpflow.utilities.to_default_float(1000.0)))
        self.lengthscale_22 = gpflow.Parameter(1.0, transform=tfp.bijectors.SoftClip(
            gpflow.utilities.to_default_float(0.00001),
            gpflow.utilities.to_default_float(1000.0)))
    ...
    def K(self, X, X2=None):
        ...
        diff_X_db_exp2 = tf.math.abs(X_matrix_db_exp2 - X_matrix_tr_db_exp2)/self.lengthscale_22
...
class K_full_model_3(gpflow.kernels.Kernel):
    ...
    def __init__(self):
        ...
        self.variance_12 = gpflow.Parameter(1.0, transform=tfp.bijectors.SoftClip(
            gpflow.utilities.to_default_float(0.00001),
            gpflow.utilities.to_default_float(1000.0)))
        self.lengthscale_12 = gpflow.Parameter(1.0, transform=tfp.bijectors.SoftClip(
            gpflow.utilities.to_default_float(0.00001),
            gpflow.utilities.to_default_float(1000.0)))
...
class K_full_model_5(gpflow.kernels.Kernel):
    ...
    def __init__(self):
        ...
        self.variance_11 = gpflow.Parameter(1.0, transform=tfp.bijectors.SoftClip(
            gpflow.utilities.to_default_float(0.00001),
            gpflow.utilities.to_default_float(1000.0)))
        self.lengthscale_11 = gpflow.Parameter(1.1, transform=tfp.bijectors.SoftClip(
            gpflow.utilities.to_default_float(0.00001),
            gpflow.utilities.to_default_float(1000.0)))
...
class K_full_model_8(gpflow.kernels.Kernel):
    ...
    def K(self, X, X2=None):
        ...
        diff_X_dc_exp2 = tf.math.abs(X_matrix_dc_exp2 - X_matrix_tr_dc_exp2)/self.lengthscale_22
