...
'''
You need to choose on of these to be True: single_replicate_no_noise, three_replicates_noise_sd_005, three_replicates_noise_sd_01.
no_noise =  noiseless data;
sd_005 = standard deviation 0.05
sd_01 = standard_devoiation is 0.1
'''
...
'''
Below we run the simulations for 2200 simulated genes in total
'''
...
'''
Aggregate the log-likelihood results
'''
...
if(flat_data):
    if(single_replicate_no_noise):
        loglik_results.to_csv('output/loglik_results_simulated_data_flat_dynamic_test.csv')
    if(three_replicates_noise_sd_005):
        loglik_results.to_csv('output/loglik_results_simulated_flat_data_noise_sd_005_dynamic_test.csv')
    if(three_replicates_noise_sd_01):
        loglik_results.to_csv('output/loglik_results_simulated_flat_data_noise_sd_01_dynamic_test.csv')
else:
    if(single_replicate_no_noise):
        loglik_results.to_csv('output/loglik_results_simulated_data_dynamic_test.csv')
    if(three_replicates_noise_sd_005):
        loglik_results.to_csv('output/loglik_results_simulated_data_noise_sd_005_dynamic_test.csv')
    if(three_replicates_noise_sd_01):
        loglik_results.to_csv('output/loglik_results_simulated_data_noise_sd_01_dynamic_test.csv')
